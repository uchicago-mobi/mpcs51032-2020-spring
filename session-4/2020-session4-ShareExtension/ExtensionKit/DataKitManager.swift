...
public func printLog(_ message: String, file: String = #file, function: String = #function, line: Int = #line) {
    #if DEVELOPMENT
        let className = file.components(separatedBy: "/").last
        print(" ❌  ----> File: \(className ?? ""), Function: \(function), Line: \(line), Message: \(message)")
    #endif
}
